...
const onRoomChange = (value) => {
  switch(value) {
    case '1': {
      ...
      pristine.addValidator(capacitySelect, () => capacitySelect.value !== value ? false : true,
    ...
    case '2': {
      ...
      pristine.addValidator(capacitySelect, () => capacitySelect.value > value || capacitySelect.value === '0' ? false : true,
    ...
    case '100': {
      ...
      const pristine = new Pristine(form, pristineConfig);
      pristine.addValidator(capacitySelect, () => capacitySelect !== '0' ? false : true,
...
const onTypeChange = () => {
  ...
  switch(typeSelect.value) {
    ...
    case 'flat': {
      ...
      const pristine = new Pristine(form, pristineConfig);
      pristine.addValidator(priceInput, () => priceInput.value * 1 < 1000 ? false : true,
    ...
    case 'hotel': {
      ...
      const pristine = new Pristine(form, pristineConfig);
      pristine.addValidator(priceInput, () => priceInput.value * 1 < 3000 ? false : true,
    ...
    case 'house': {
      ...
      const pristine = new Pristine(form, pristineConfig);
      pristine.addValidator(priceInput, () => priceInput.value * 1 < 5000 ? false : true,
    ...
    case 'palace': {
      ...
      const pristine = new Pristine(form, pristineConfig);
      pristine.addValidator(priceInput, () => priceInput.value * 1 < 10000 ? false : true,
